...
(def pitch-tendencies ; major, p158-159.
  {do {do 0.03416, di 0.00008, re 0.02806, ri 0.00022, mi 0.01974, fa 0.00210, fi 0.00013  so 0.01321,             la 0.00839,             ti 0.02321}
   ...
   mi {do 0.01555, di 0.00004  re 0.04865, ri 0.00005  mi 0.03142, fa 0.02644, fi 0.00088  so 0.02365, si 0.00003, la 0.00281,             ti 0.00029}
   fa {do 0.00054, di 0.00002  re 0.01260, ri 0.00084  mi 0.04127, fa 0.01506, fi 0.00004  so 0.01712, si 0.00003  la 0.00441, li 0.00006  ti 0.00125}
   fi {do 0.00003              re 0.00016              mi 0.00037, fa 0.00010, fi 0.00040, so 0.00257, si 0.00002, la 0.00040,             ti 0.00003}
   so {do 0.02557, di 0.00001  re 0.00530, ri 0.00037  mi 0.02854, fa 0.03653, fi 0.00207, so 0.04835, si 0.00019, la 0.02076, li 0.00054, ti 0.00369}
   si {do 0.00001,                                     mi 0.00001  fa 0.00002  fi 0.00001, so 0.00011, si 0.00002, la 0.00014, li 0.00003, ti 0.00002}
   la {do 0.00238, di 0.00004, re 0.00168,             mi 0.00065, fa 0.00342, fi 0.00037, so 0.03642, si 0.00017, la 0.01261, li 0.00070, ti 0.00854}
   li {do 0.00062,             re 0.00003, ri 0.00008, mi 0.00001, fa 0.00003,             so 0.00043,             la 0.00119, li 0.00048,           }
   ti {do 0.02025,             re 0.00510,             mi 0.00035, fa 0.00029, fi 0.00010, so 0.00323, si 0.00006, la 0.01327, li 0.00001, ti 0.00448}})
